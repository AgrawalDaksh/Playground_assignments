 ...
 */
let walkingChallenges = ["Walk 3 miles a day", "Take 10,000 steps every day","Walk for 30 minutes each morning"]
let runningChallenges = ["Run 5 times a week","Run 2 miles every day","Complete a 10K by the end of the month"]
