...
progressUpdate(steps: 1000, goal: 8000)
progressUpdate(steps: 5000, goal: 8000)
progressUpdate(steps: 7500, goal: 8000)
progressUpdate(steps: 8060, goal: 8000)
...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    ...
    let totalPace = currentTime / totalDistance
    if pace < totalPace {
        print("Keep it up!")
    } else {
...
pacing(currentDistance: 35, totalDistance: 32, currentTime: 30, goalTime: 25)
pacing(currentDistance: 35, totalDistance: 40, currentTime: 30, goalTime: 50)
