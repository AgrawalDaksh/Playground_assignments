...
func returnMeal(meal: String) -> Meal? {
    if let someVar = meals[meal] {
        return someVar
    }
    return nil
}
var someVar = returnMeal(meal: "Breakfast")
if let someVar2 = someVar {
    print(someVar2)
}
else {
    print("Nil")
 ...
 */
func checkMealLog() -> Any? {
    if let someVar = UserDefaults.standard.dictionary(forKey: "mealLog") {
        return someVar
    }
    return nil
}
var variable = checkMealLog()
print(variable ?? "nil")
