...
print(userInputAge)
print("Error is: Value of optional type 'Int?' must be unwrapped to a value of type 'Int'")
print(userAge)
...
print("The value of userAge is nil because 34e cannot be converted to int and nil represents absense of a value")
