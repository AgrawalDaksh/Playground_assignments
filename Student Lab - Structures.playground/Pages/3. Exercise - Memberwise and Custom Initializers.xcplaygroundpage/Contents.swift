...
let favoriteBook = Book(title: "The Kite Runner", author: "Khaled Hosseini", pages: 374, price: 299)
print("My favorite book is \"\(favoriteBook.title)\" written by \(favoriteBook.author).")
...
let laptop2 = Laptop(screenSize: 15, repairCount: 2, yearPurchased: 2022)
